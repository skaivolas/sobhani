...
Note that this is a full-width `Jeremy walker` layout. This was accomplished by including `layout: full-width` in the YAML front matter for this page. Keep in mind that all the Tufte-Jekyll sidenote and marginnote goodness will not work on full-width layouts!
