...
<blockquote>
<p class="citation">Dans le discours, les mots contractent entre eux, en vertu de leur enchaînement, des rapports fondés sur le caractère linéaire de la langue, qui exclut de prononcer deux éléments à la fois […]. Ceux-ci se rangent les uns à la suite des autres sur la chaîne de la parole. (Saussure 1955, p. 170)</p>
</blockquote>
...
<p class="texte"><span class="paranumber">69</span>Dans le passage suivant, Chomsky résume clairement les termes du problème et la position qu’il adopte :</p>
<blockquote>
...
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn10" id="ftn10">10</a> Il faut noter que la c-commande est définie en (12) en termes de « premier nœud dominant A » et non en termes de « premier nœud branchant dominant A », comme dans la version classique de cette notion, donnée en (i) :</p>
<table class="example">
<tr>
<td></td>
...
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn14" id="ftn14">14</a> Si l’analyse proposée capture l’intuition que les clitiques dépendant de la même tête se regroupent en un <em>cluster</em>, elle peine à représenter de façon naturelle la relation existant entre v/T, V et le ou les clitiques qui en dépendent. Ce point apparaît clairement quand on considère un deuxième exemple d’adjonction multiple, correspondant aux structures clitique-verbe ou verbe-clitique dans les langues romanes. On admet généralement que la tête X à laquelle s’adjoint un clitique est une tête fonctionnelle v ou T, non la tête lexicale V. On admet aussi que V s’adjoint indépendamment à cette tête. Si l’adjonction multiple à la même tête n’est pas une option disponible, il faut admettre que dans les structures où le clitique est proclitique, il s’adjoint à V après que V s’est adjoint à v ou T et que dans celles où il est enclitique, il s’est adjoint à v ou T, avant que le verbe ne s’adjoigne au clitique, produisant une tête clitique complexe adjointe [<sub>CL</sub> V-CL]. </p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn15" id="ftn15">15</a> Cela implique que les relatives appositives doivent aussi être dérivées par montée, une analyse difficile à soutenir. </p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn16" id="ftn16">16</a> En (22b), OP désigne l’opérateur nul occupant le spécifieur du CP relatif.</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn17" id="ftn17">17</a> On peut vérifier que, tel qu’il est formulé, le LCA exclut également la multidominance (voir IV.3.3). </p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn18" id="ftn18">18</a> Chomsky note également que « cette approche élimine le paramètre de la tête, mais au prix d’en introduire beaucoup d’autres (les options requises pour produire les hiérarchies appropriées), ainsi que des complications techniques ». </p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn19" id="ftn19">19</a> Kayne (1994) propose une solution à cette difficulté.</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn20" id="ftn20">20</a> Brody (2003, p. 205) exprime une idée proche : « Ce sont les écarts par rapport à la symétrie plutôt que les symétries elles-mêmes qui, typiquement, requièrent une explication. »</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn21" id="ftn21">21</a> Les énoncés suivants découverts par Ernst (2001), également discutés par Lasnik et Uriagereka (2005) et Johnson (2007), illustrent une situation de ce type.</p>
<table class="example">
<tr>
<td></td>
<td>(i) </td>
<td>Un dinosaure qui est gros qui est petit n’est pas la même chose qu’un dinosaure qui est petit qui est gros.</td>
</tr>
<tr>
<td> </td>
<td>(ii) </td>
<td>Un gros petit dinosaure n’est pas la même chose qu’un petit gros dinosaure.</td>
</tr>
</table>
<p class="texte">Quand les modifieurs précèdent le nom comme en (ii), l’interprétation est que le modifieur qui précède inclut dans sa portée le modifieur qui suit : <em>gros petit dinosaure</em> réfère à un dinosaure qui est gros pour un petit dinosaure… Il est plausible de supposer que le premier adjectif c-commande le second – les relations de portée ayant un support structural. Dans ce cas, il est légitime de poser que la c-commande asymétrique se traduit en précédence linéaire. Il n’en va de même en (i), où la seconde relative dans chaque expression nominale est interprétée comme portant sur la combinaison formée par le nom et la première relative. Or si la seconde relative c-commandait la première, elle devrait, dans les termes du LCA, la précéder. Les propositions développées par Cinque (2010) permettent une analyse différente de ces données, compatible avec la thèse antisymétrique forte. Il en va de même pour les données chinoises qui viennent d’être évoquées. </p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn22" id="ftn22">22</a> Uriagereka (1999b) cherche à simplifier le LCA en faisant l’économie de l’étape « inductive » formulée en (i) :</p>
<table class="example">
<tr>
<td></td>
<td>(i) </td>
...
<p class="texte">Il propose que la linéarisation comporte plusieurs étapes et que chaque étape ne comporte que des unités de commande. C’est l’hypothèse du <em>Spell-Out</em> multiple, dont l’incidence sur la caractérisation du LCA sera discutée en VIII.5.2. </p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn23" id="ftn23">23</a> <em>BPS</em> (p. 420 et suiv.) contient une version plus développée du même texte.</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn24" id="ftn24">24</a> Si K en (23) est lui-même un segment, non une catégorie séparée, on a affaire à une structure d’adjonction, où j ou L est également un segment. L’ordre entre la cible de l’adjonction et l’adjoint dépend de la définition de c-commande que l’on adopte.</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn25" id="ftn25">25</a> On se souvient que Kayne obtient ce résultat en recourant à la distinction entre catégorie et segment et en modifiant la définition de la c-commande, ce que Chomsky veut absolument éviter, pour d’excellentes raisons, semble-t-il.</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn26" id="ftn26">26</a> Gärtner (1995) observe que cette invisibilité a des implications touchant la linéarisation même des structures syntaxiques dans les termes du LCA. On se souvient qu’afin de définir la relation de précédence de façon appropriée, il faut garantir que dans la structure (i) – qui est (24) avec K = L –, m et p ne c-commandent pas asymétriquement a et b.</p>
<table class="example">
<tr>
<td></td>
<td>(i) </td>
<td>[<sub>L</sub> [<sub>J</sub> a b] [<sub>L</sub> m p]]</td>
</tr>
</table>
<p class="texte">Du fait de son invisibilité, L = m p ne c-commande pas le spécifieur J = a b. Mais d’autre part, ni m ni p ne doivent pouvoir c-commander en dehors de L. Dans une note de <em>C&amp;T</em> (note 110), Chomsky observe que « L fait partie de la structure » et que la structure branchante est préservée. Gärtner remarque avec raison que « faire partie de la structure n’est pas la même chose que faire partie de la structure visible » et qu’inversement, « ne pas faire partie de la structure visible n’implique pas ne pas faire partie de la structure ».</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn27" id="ftn27">27</a> Ces constructions posent également un problème d’étiquetage, voir section 1.</p>
<p class="texte"><a class="FootnoteSymbol" href="#bodyftn28" id="ftn28">28</a> Certains linguistes, Koster (2007), de Vries (2009) et Kayne (2011) parmi d’autres, maintiennent au contraire que <em>Merge</em> et la relation de sœur qui en résulte sont asymétriques. </p> </div><!-- #notes -->
